 ...
 * @author ACER
 */
public class RoundTabletrasach extends JTable {
    public RoundTabletrasach(DefaultTableModel model) {
        super(model);
        setRowHeight(40);
        ...
        if (columnModel.getColumnCount() > 0) {
            columnModel.getColumn(0).setHeaderRenderer(new ImageHeaderRenderer("image/application.png", "Mã phiếu trả"));
            columnModel.getColumn(1).setHeaderRenderer(new ImageHeaderRenderer("image/publisher.png", "Mã phiếu mượn"));
            columnModel.getColumn(2).setHeaderRenderer(new ImageHeaderRenderer("image/write.png", "Ngày trả"));
