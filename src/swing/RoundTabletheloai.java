 ...
 * @author ACER
 */
public class RoundTabletheloai extends JTable{
    public RoundTabletheloai(DefaultTableModel model) {
        super(model);
        setRowHeight(40);
        ...
        if (columnModel.getColumnCount() > 0) {
            columnModel.getColumn(0).setHeaderRenderer(new ImageHeaderRenderer("image/application.png", "Mã thể loại"));
            columnModel.getColumn(1).setHeaderRenderer(new ImageHeaderRenderer("image/name.png", "Tên thể loại"));
