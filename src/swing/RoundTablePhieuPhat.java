...
public class RoundTablePhieuPhat extends JTable {
    ...
    public RoundTablePhieuPhat(DefaultTableModel model) {
        ...
        if (columnModel.getColumnCount() > 0) {
            columnModel.getColumn(0).setHeaderValue("Mã phiếu phạt");
            columnModel.getColumn(1).setHeaderValue("Mã phiếu trả");
            columnModel.getColumn(2).setHeaderValue("Số tiền phạt");
            columnModel.getColumn(3).setHeaderValue("Lý do");
            columnModel.getColumn(4).setHeaderValue("Trạng thái thanh toán");
        }
